      ...
      <div className="w-full flex items-center justify-between gap-2 mt-3 min-h-[44px]">
        ...
        <button
          ...
          className="
            ...
            bg-red-500/[0.18] border border-red-300/40 text-red-300 backdrop-blur-xl
        ...
        <button
          ...
          className="
            px-5 py-2.5 rounded-full flex-shrink-0
            font-[Outfit] font-bold text-[11px] tracking-[0.06em] uppercase
            bg-gradient-to-br from-green-500/30 to-green-700/25 border border-green-400/50 text-green-200 backdrop-blur-xl
